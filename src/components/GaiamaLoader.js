    ...
    >
      ...
      <g>
        <Path
          ...
          fill="url(#gradient1)"
          css={{
            animation: `1.1s linear 0s 100 alternate both running ${diamondAnimation}`,
          }}
        />
        <Path
          ...
          fill="url(#gradient1)"
          css={{
            animation: `1.1s linear 0s 100 alternate both running ${outerAnimation}`,
          }}
        />
        <Path
          ...
          fill="url(#gradient2)"
          css={{
            animation: `1.1s linear 0s 100 alternate both running ${innerAnimation}`,
          }}
        />
      </g>
    </svg>
